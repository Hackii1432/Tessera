...
Tessera's integrated, Paper-derived server base. Use the Gradle wrapper in the
Tessera repository root, not this directory. See [the local baseline](BASELINE.md)
and [the Sinopia workflow](../docs/SINOPIA-WORKFLOW.md).

The following is the retained upstream Paper documentation. Its downloads,
badges and contribution links describe Paper, not Sinopia releases.
