...
if (!file(".git").exists()) {
    val errorText = """
        ...
        =====================[ ERROR ]=====================
         Sinopia is the versioned base inside the Tessera repository.
         Do not run Gradle directly in the sinopia source directory.

         From the Tessera repository root, run:
           ./gradlew buildTessera          (build the final server)
           ./gradlew applySinopiaPatches  (prepare the editable base)

         On Windows use .\gradlew.bat instead of ./gradlew.
         See docs/SINOPIA-WORKFLOW.md in the Tessera repository.
        ===================================================
    """.trimIndent()
    error(errorText)
}

rootProject.name = "sinopia"
