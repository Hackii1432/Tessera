...
paperweight {
    ...
    updatingMinecraft {
        // Tessera - Paper's update baseline is not a commit in this downstream repository.
    }
}
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Sinopia",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Sinopia",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "MosaikDev",
            "Brand-Id" to "mosaikdev:sinopia",
            "Brand-Name" to "Sinopia",
