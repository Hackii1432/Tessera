...
public class PaperVersionFetcher implements VersionFetcher {
    ...
    public Component getVersionMessage() {
        if (BUILD_INFO.brandName().equals("Sinopia")) {
            return text("Sinopia " + BUILD_INFO.asString(VERSION_SIMPLE) + " (local Tessera base; no public release channel)", NamedTextColor.YELLOW);
        }
    ...
    public static void getUpdateStatusStartupMessage() {
        if (BUILD_INFO.brandName().equals("Sinopia")) {
            COMPONENT_LOGGER.info(text("Sinopia: integrated Tessera base; automatic upstream release comparison is not applicable."));
            return;
        }
